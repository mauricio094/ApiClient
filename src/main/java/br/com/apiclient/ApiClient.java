...
public class ApiClient {
    public static String urlSandboxV2 = "http://api-sandbox.netshoes.com.br/api/v2";
    public static String urlSandboxV1 = "http://api-sandbox.netshoes.com.br/api/v1";

    public static String parametroProdutos = "products";
    public static String parametroMarcas = "brands";
